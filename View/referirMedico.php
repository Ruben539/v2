...
require_once('../Controllers/referirMedico.php');
?>
    ...
    <div class="row">
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="col-md-6 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title text-center">Referir Medico a Comisionista<i class="typcn typcn-user"></i></h4>
              <p class="card-description text-center">
                Datos del medico a referir
              </p>
              <form class="forms-sample" method="POST" action="">
                ...
                <button type="submit" class="btn btn-primary mr-2">Referir</button>
