    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4>Agendamientos por Medicos <i class="typcn typcn-device-tablet"></i> </h4>

                        <form class="row" method="POST" action="../Reports/reporteAgendamiento.php" target="_blank">
                            <div class="col-md-5">
        ...
        <script type="text/javascript">
            $('#formMedicos').submit(function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: '../Reports/reporteAgendamiento.php',
                    data: form.serialize(),
